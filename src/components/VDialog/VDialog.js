...
export default {
  ...
  computed: {
    classes () {
      return {
        [(`vf-dialog ${this.contentClass}`).trim()]: true,
        'vf-dialog--active': this.isActive,
        'vf-dialog--persistent': this.persistent,
        'vf-dialog--fullscreen': this.fullscreen,
        'vf-dialog--stacked-actions': this.stackedActions && !this.fullscreen,
        'vf-dialog--scrollable': this.scrollable
      }
    },
    contentClasses () {
      return {
