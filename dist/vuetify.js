  ...
  methods: {
    ...
    addTextColorClassChecks: function addTextColorClassChecks() {
      ...
      if (prop && this[prop]) {
        ...
        if (parts.length > 1) color += ' vf-text--' + parts[1];
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  bind: function bind(el, binding, v) {
    ...
    var app = document.querySelector('[vf-data-app]') || document.body; // This is only for unit tests
...
var ripple = {
  ...
  show: function show(e, el, _ref) {
    ...
    container.className = 'vf-ripple__container';
    ...
    animation.className = 'vf-ripple__animation';
    ...
    animation.classList.add('vf-ripple__animation--enter');
    animation.classList.add('vf-ripple__animation--visible');
    style(animation, 'translate(-50%, -50%) translate(' + x + ', ' + y + ') scale3d(0.01,0.01,0.01)');
    animation.dataset.activated = Date.now();

    setTimeout(function () {
      animation.classList.remove('vf-ripple__animation--enter');
  ...
  hide: function hide(el) {
    ...
    var ripples = el.getElementsByClassName('vf-ripple__animation');
    ...
    setTimeout(function () {
      animation.classList.remove('vf-ripple__animation--visible');
  ...
  methods: {
    ...
    genIcon: function genIcon(type) {
      ...
      return this.$createElement('v-icon', {
        'class': (_class = {}, _defineProperty(_class, 'vf-input-group__' + type + '-icon', true), _defineProperty(_class, 'vf-input-group__icon-cb', !!callback), _defineProperty(_class, 'vf-input-group__icon-clearable', shouldClear), _class),
        props: {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    genRipple: function genRipple() {
      ...
      data.class = this.rippleClasses || 'vf-input-group--selection-controls__ripple';
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function data() {
    return {
      isDependent: false,
      stackClass: 'vf-dialog__content__active',
      stackMinZIndex: 200
    };
  },
  ...
  computed: {
    classes: function classes() {
      ...
      return _ref = {}, _defineProperty(_ref, ('vf-dialog ' + this.contentClass).trim(), true), _defineProperty(_ref, 'vf-dialog--active', this.isActive), _defineProperty(_ref, 'vf-dialog--persistent', this.persistent), _defineProperty(_ref, 'vf-dialog--fullscreen', this.fullscreen), _defineProperty(_ref, 'vf-dialog--stacked-actions', this.stackedActions && !this.fullscreen), _defineProperty(_ref, 'vf-dialog--scrollable', this.scrollable), _ref;
    },
    contentClasses: function contentClasses() {
      return {
        'vf-dialog__content': true,
        'vf-dialog__content__active': this.isActive
      };
    }
  },
  ...
  methods: {
    genOverlay: function genOverlay() {
      ...
      if (!this.isActive || this.hideOverlay || this.isActive && this.overlayTimeout || this.overlay) {
        ...
        return this.overlay && this.overlay.classList.add('vf-overlay--active');
      }
      ...
      requestAnimationFrame(function () {
        _this.overlay.className += ' vf-overlay--active';
  ...
  methods: {
    genProgress: function genProgress() {
      ...
      return this.$slots.progress || this.$createElement('v-progress-linear', {
        props: {
          color: this.loading === true || this.loading === '' ? this.color || 'vf-primary' : this.loading,
          height: 2,
          indeterminate: true
        }
      });
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    titleColor: function titleColor() {
      ...
      var defaultTitleColor = darkTheme ? null : 'vf-primary';
...
function Doctify(Vue, args) {
  var Doctify = __WEBPACK_IMPORTED_MODULE_2__components__["Doctify"];
...
Doctify.version = __WEBPACK_IMPORTED_MODULE_1__package_json__["version"];
...
/* harmony default export */ __webpack_exports__["default"] = (Doctify);
...
/* harmony default export */ __webpack_exports__["a"] = (Doctify);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h) {
    ...
    var wrapper = h('div', { staticClass: 'vf-application--wrap' }, this.$slots.default);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    classes: function classes() {
      ...
      var classes = {
        'vf-alert--dismissible': this.dismissible,
        'vf-alert--outline': this.outline
      };
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h) {
    ...
    var contentClass = ['vf-bottom-sheet', this.inset ? 'vf-bottom-sheet--inset' : ''].join(' ');
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    classes: function classes() {
      return {
        'vf-breadcrumbs--large': this.large
      };
    },
  ...
  methods: {
    ...
    genChildren: function genChildren() {
      ...
      var children = [];
      var dividerData = { staticClass: 'vf-breadcrumbs__divider' };
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props: {
    ...
    activeClass: {
      type: String,
      default: 'vf-breadcrumbs__item--disabled'
    }
  },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    genDelimiters: function genDelimiters() {
      return this.$createElement('div', {
        staticClass: 'vf-carousel__controls'
      }, this.genItems());
    },
    genIcon: function genIcon(direction, icon, fn) {
      ...
      return this.$createElement('div', {
        staticClass: 'vf-carousel__' + direction
    ...
    genItems: function genItems() {
      ...
      return this.items.map(function (item, index) {
        return _this2.$createElement(__WEBPACK_IMPORTED_MODULE_0__VBtn__["a" /* default */], {
          class: {
            'vf-carousel__controls__item': true,
            'vf-carousel__controls__item--active': index === _this2.inputValue
          },
          props: {
            icon: true,
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h) {
    var item = h('div', {
      class: {
        'vf-carousel__item': true,
        'vf-reverse': this.reverse
      },
      style: this.styles,
      on: this.$listeners,
      directives: [{
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h) {
    var transition = h('v-fade-transition', [h('v-icon', {
      ...
      'class': {
        'vf-icon--checkbox': this.icon === 'check_box'
      },
      key: this.icon,
      on: Object.assign({
        click: this.toggle
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    classes: function classes() {
      return {
        'vf-list--group__header': true,
        'vf-list--group__header--active': this.isActive,
        'vf-list--group__header--no-action': this.noAction
      };
    }
  },
  ...
  methods: {
    click: function click() {
      ...
      if (!this.$refs.item.querySelector('.vf-list__tile--disabled')) {
        requestAnimationFrame(function () {
  ...
  render: function render(h) {
    ...
    return h('li', { 'class': 'vf-list--group__container' }, [item, transition]);
  }
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    ...
    listIndex: function listIndex(next, prev) {
      ...
      if (next in this.tiles) {
        this.tiles[next].classList.add('vf-list__tile--highlighted');
        this.$refs.content.scrollTop = next * 48;
      }

      prev in this.tiles && this.tiles[prev].classList.remove('vf-list__tile--highlighted');
    }
  },
  ...
  methods: {
    ...
    getTiles: function getTiles() {
      this.tiles = this.$refs.content.querySelectorAll('.vf-list__tile');
    }
  }
});
  ...
  methods: {
    ...
    calcTopAuto: function calcTopAuto() {
      ...
      var selectedIndex = Array.from(this.tiles).findIndex(function (n) {
        return n.classList.contains('vf-list__tile--active');
      });
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    genHighlight: function genHighlight(text) {
      ...
      return '<span class="vf-list__tile__mask">' + Object(__WEBPACK_IMPORTED_MODULE_0__util_helpers__["f" /* escapeHTML */])(text) + '</span>';
    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    genActions: function genActions() {
      return this.$createElement('div', {
        'class': 'vf-small-dialog__actions'
  ...
  render: function render(h) {
    ...
    return h('v-menu', {
      'class': 'vf-small-dialog',
      props: {
        contentClass: 'vf-small-dialog__content',
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    genTable: function genTable(tableChildren, touchCallback) {
      ...
      var options = {
        staticClass: 'vf-picker--date__table',
        'class': {
          'vf-picker--month__table': this.activePicker === 'MONTH'
        },
    ...
    genPickerBody: function genPickerBody(h) {
      ...
      if (this.activePicker === 'DATE') {
        pickerBodyChildren.push(h('div', { staticClass: 'vf-picker--date__header' }, [this.genSelector()]));
  ...
  render: function render(h) {
    ...
    return h('v-card', {
      staticClass: 'vf-picker vf-picker--date',
      'class': _extends({
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h) {
    return h('ul', {
      staticClass: 'vf-expansion-panel',
      'class': _extends({
        'vf-expansion-panel--focusable': this.focusable,
        'vf-expansion-panel--popout': this.popout,
        'vf-expansion-panel--inset': this.inset
      }, this.themeClasses)
    }, this.$slots.default);
  }
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    genBody: function genBody() {
      return this.$createElement('div', {
        ref: 'body',
        class: 'vf-expansion-panel__body',
        directives: [{
          name: 'show',
          value: this.isActive
        }]
    ...
    genHeader: function genHeader() {
      ...
      return this.$createElement('div', {
        staticClass: 'vf-expansion-panel__header',
        directives: [{
          name: 'ripple',
          value: this.ripple
        }],
  ...
  render: function render(h) {
    ...
    return h('li', {
      staticClass: 'vf-expansion-panel__container',
      'class': {
        'vf-expansion-panel__container--active': this.isActive
      },
      attrs: {
        tabindex: 0
      },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h) {
    var data = {
      staticClass: 'vf-content',
      style: this.styles,
      ref: 'content'
    };

    return h('div', {
      staticClass: 'vf-content--wrap'
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    classes: function classes() {
      return {
        'vf-navigation-drawer': true,
        'vf-navigation-drawer--absolute': this.absolute,
        'vf-navigation-drawer--clipped': this.clipped,
        'vf-navigation-drawer--close': !this.isActive,
        'vf-navigation-drawer--fixed': this.fixed,
        'vf-navigation-drawer--floating': this.floating,
        'vf-navigation-drawer--is-mobile': this.isMobile,
        'vf-navigation-drawer--mini-variant': this.miniVariant,
  ...
  render: function render(h) {
    ...
    return h('aside', data, [this.$slots.default, h('div', { 'class': 'vf-navigation-drawer__border' })]);
  }
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    classes: function classes() {
      return {
        'vf-pagination': true,
        'vf-pagination--circle': this.circle,
        'vf-pagination--disabled': this.disabled
      };
    },
    items: function items() {
  ...
  methods: {
    ...
    genIcon: function genIcon(h, icon, disabled, fn) {
      return h('li', [h('button', {
        staticClass: 'vf-pagination__navigation',
        class: {
          'vf-pagination__navigation--disabled': disabled
        },
    ...
    genItem: function genItem(h, i) {
      ...
      return h('button', {
        staticClass: 'vf-pagination__item',
        class: i === this.value ? this.addBackgroundColorClassChecks({
          'vf-pagination__item--active': true
        }) : {},
        on: {
          click: function click() {
    ...
    genItems: function genItems(h) {
      ...
      return this.items.map(function (i) {
        return h('li', [isNaN(i) && h('span', { class: 'vf-pagination__more' }, [i]) || _this3.genItem(h, i)]);
      });
    }
  },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    classes: function classes() {
      return this.addTextColorClassChecks({
        'vf-progress-circular': true,
        'vf-progress-circular--indeterminate': this.indeterminate,
        'vf-progress-circular--button': this.button
      });
    },
    cxy: function cxy() {
  ...
  methods: {
    genCircle: function genCircle(h, name, offset) {
      return h('circle', {
        class: 'vf-progress-circular__' + name,
        attrs: {
          fill: 'transparent',
          cx: this.cxy,
          cy: this.cxy,
  ...
  render: function render(h) {
    var info = h('div', { class: 'vf-progress-circular__info' }, [this.$slots.default]);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    classes: function classes() {
      return {
        'vf-radio-group': true,
        'vf-radio-group--column': this.column && !this.row,
        'vf-radio-group--row': this.row,
        'vf-error--text': this.hasError
      };
    }
  },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    this.app = document.querySelector('[data-app-vf]') || console.warn('The v-slider component requires the presence of v-app or a non-body wrapping element with the [data-app] attribute.');
  },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    slider: function slider(el) {
      ...
      this.tabsSlider = this.tabsSlider || !!this.$el && this.$el.querySelector('.vf-tabs__slider');

      this.tabsContainer = this.tabsContainer || !!this.$el && this.$el.querySelector('.vf-tabs__container');
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    callSlider: function callSlider() {
      ...
      setTimeout(function () {
        _this.$el.firstChild.classList.contains('vf-tabs__item--active') && _this.slider(_this.$el);
      }, 0);
    },
    click: function click(e) {
      e.preventDefault();
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    classes: function classes() {
      return this.addBackgroundColorClassChecks({
        'vf-toolbar': true,
        'vf-elevation-0': this.flat,
        'vf-toolbar--absolute': this.absolute,
        'vf-toolbar--card': this.card,
        'vf-toolbar--clipped': this.clippedLeft || this.clippedRight,
        'vf-toolbar--dense': this.dense,
        'vf-toolbar--fixed': this.fixed,
  ...
  render: function render(h) {
    ...
    children.push(h('div', {
      staticClass: 'vf-toolbar__content',
    ...
    if (this.isExtended) {
      children.push(h('div', {
        staticClass: 'vf-toolbar__extension',
        style: { height: this.computedHeight + 'px' }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h, _ref) {
    ...
    var classes = data.staticClass ? data.staticClass + ' vf-toolbar__side-icon' : 'vf-toolbar__side-icon';
